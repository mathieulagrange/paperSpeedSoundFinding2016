...
\title{A novel interface for audio based sound data mining \ml{find a better title that put the focus on semantic versus acoustic organizations}}
...
\affil{IRCCyN, Ecole Centrale de Nantes $^1$ \quad\quad\quad\quad IRCAM $^2$}
}
...
\keywords{audio-based sound data mining, listening oriented user interface, crowdsourcing experiment}

...
Using the $IQR$ method, 5 subjects are detected as outliers and removed from the analysis. 2 of those subjects used PD and 3 subjects AD. %Table~\ref{tab1} shows the criteria used to detect the 5 outliers. 
